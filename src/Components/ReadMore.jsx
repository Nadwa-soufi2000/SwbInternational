...
{
    return(
        <div className="w-full 2xl:w-[90%] flex flex-col justify-center items-center">
           <div className="flex justify-between items-center w-full p-1">
              ...
              <Link to={`${props.link}`} className='rounded-[11px] flex justify-center items-center bg-[#A2948A] text-[#FFFFFF] text-[12px] sm:text-[18px] md:text-[18px] lg:text-[20px] xl:text-[22px] w-[84px] h-[30px] sm:w-[170px] sm:h-[40px] md:w-[180px] md:h-[45px] lg:w-[205px] lg:h-[56px]  xl:w-[205px] xl:h-[56px]  gap-[3px] hover:border-[5px] duration-500 hover:border-[#817b7b] hover:border-solid'>Read More <MdOutlineArrowRightAlt className='fill-current text-[#FFFFFF] mt-[3px] sm:mt-[4px]'/></Link>    
           </div>
          { props.p1 && props.p2 &&
