...
export default function BostaniChocolateDescription(props) 
{
    ...
    return(
        <div className='flex flex-col gap-1 sm:gap-[7px] justify-center items-start py-[20px] sm:py-0 pl-[10px] sm:pl-[30px] bg-[#f0ecea] rounded-[15px] shadow-xl' style={{width: size.windowSize > '1024' ? props.width : size.windowSize > '768' ? '70%' : '290px', height: size.windowSize > '1024' ? props.height : props.diff2 ? '290px' : 'auto' , rotate: size.windowSize > '1024' || props.diff ? '0deg' : '180deg'}}>
