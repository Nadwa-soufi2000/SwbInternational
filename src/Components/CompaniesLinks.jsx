...
export default function CompaniesLinks(props)
{
   const closeList = () =>
    ...
    return(
         <div className='bg-black hidden md:hidden z-[1] lg:flex xl:flex justify-center items-start py-[10px] gap-[20px] lg:w-[300px] xl:w-[400px] px-[10px] flex-col rounded-[14px] absolute lg:top-[12%] xl:top-[10%] right-[17%] duration-1000 delay-1000' id='Companies'>
             ...
             <Link to='/bostaniChocolate' className='w-full flex text-[#FFFFFF] justify-between items-center lg:text-[15px] xl:text-[18px] hover:bg-white/20 hover:pl-[15px] p-[8px] hover:rounded-[10px] duration-[0.5s]'><p>Bostani Chocolate</p><MdOutlineKeyboardArrowRight className='fill-current text-[#FFFFFF]'/></Link>
              <Link to='/bostaniCocoaFarming' className='w-full flex text-[#FFFFFF] justify-between items-center lg:text-[15px] xl:text-[18px] hover:bg-white/20 hover:pl-[15px] p-[8px] hover:rounded-[10px] duration-[0.5s]'><p>Bostani(IVORY COAST)</p><MdOutlineKeyboardArrowRight className='fill-current text-[#FFFFFF]'/></Link>
