...
export default function AboutLinks(props)
{
    ...
    return(
         <div className='bg-black hidden md:hidden lg:flex xl:flex justify-center items-start py-[10px] gap-[20px] lg:w-[300px] xl:w-[400px] px-[10px] flex-col rounded-[14px] absolute lg:top-[12%] xl:top-[10%] right-[27%]' id='About'>
